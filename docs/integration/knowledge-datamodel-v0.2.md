...
```text
Status:     v0.2.1. Revised after review-of-v0.2.md, which found six defects in
            the first revision. All six fixed; see review-disposition-v0.2.md.
...
Driven by:  audit-response-v0.1.md — every change below traces to a finding in
...
Reads with: contract-v0.2.md (the promises), audit-disposition-v0.1.md (the
            reasoning behind each decision), planning-asks-v0.2.md (what we need
            from you, and when).
```
...
**All five were accepted in `review-of-v0.2.md` §4**, including N2, where the review
...
### From `review-of-v0.2.md` — the six that blocked authoring
