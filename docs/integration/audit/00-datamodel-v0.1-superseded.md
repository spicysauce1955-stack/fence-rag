...
>
> **Read [`knowledge-datamodel.md`](../knowledge-datamodel.md) instead.**
>
> This document was audited by the Knowledge team in `01-audit-response.md`, and
...
```text
Status:    SUPERSEDED by knowledge-datamodel.md. Audited 2026-08-24.
...
Outcome:   §7 was answered in full. See 01-audit-response.md, then
           02-audit-disposition.md, then knowledge-datamodel.md §8 for
