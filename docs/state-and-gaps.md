...
| Tests | `tests/` | 721 tests, stdlib only; all pass over a full store, `OK (skipped=7)` after a clean rebuild (the promotion tests) |
...
| facts: extracted / flagged | 1,448 / 266 — **1,714 total** (measured 2026-08-25, after A1-A5) |
...
| schema_version | 3 |
| quality issues | 374 |
| derived image data on disk | 4.9 GB (git-ignored, reproducible) |
