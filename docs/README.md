...
| [`coverage-remediation-plan.md`](coverage-remediation-plan.md) | **A MEASURED INVENTORY**, rewritten 2026-09-14 after four of its own items were attempted and **three dissolved on contact** — the first draft's prescriptions were written from reading, not measuring. §1 is what shipped; §2 is the inventory of what could actually publish (and records that the structural-parameter backlog is **empty**); §5 lists the decisions that are the owner's, not an engineer's |
